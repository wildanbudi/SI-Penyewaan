...
<br><br>
		...
		<div class= "container col-md-10">  			
  			<div class="row">
  				<div class="col-md-12">
  					<form method="post" action="aksi_addbarang.php" class='form-horizontal'>
				    <h2>Tambah Barang</h2>
					  <!-- <div class="form-group">
					    <label class="col-sm-1 control-label">Kode Barang</label>
					    <div class="col-sm-10">
					      <input type="text" name='id barang' class="form-control">
					    </div>
					  </div> -->
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" class="form-control" name='merk'></textarea>
					    </div>
					  </div>
